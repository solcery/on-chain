...
class Transaction {
  ...
  _serialize(signData) {
    ...
    invariant(wireTransaction.length <= PACKET_DATA_SIZE, "Transaction too large: ".concat(wireTransaction.length, " > ").concat(PACKET_DATA_SIZE));
...
class Secp256k1Program {
  ...
  static publicKeyToEthAddress(publicKey) {
    invariant(publicKey.length === PUBLIC_KEY_BYTES, "Public key must be ".concat(PUBLIC_KEY_BYTES, " bytes but received ").concat(publicKey.length, " bytes"));
  ...
  static createInstructionWithEthAddress(params) {
    ...
    invariant(ethAddress.length === ETHEREUM_ADDRESS_BYTES, "Address must be ".concat(ETHEREUM_ADDRESS_BYTES, " bytes but received ").concat(ethAddress.length, " bytes"));
  ...
  static createInstructionWithPrivateKey(params) {
    ...
    invariant(pkey.length === PRIVATE_KEY_BYTES, "Private key must be ".concat(PRIVATE_KEY_BYTES, " bytes but received ").concat(pkey.length, " bytes"));
